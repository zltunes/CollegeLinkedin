...
//    self.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.3f];
    ...
    self.bgColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:1];
    ...
    blurView = [[FXBlurView alloc]initWithFrame:CGRectMake(0, 0, self.referView.frame.size.width, self.referView.frame.size.height)];
...
- (void)show
{
    ...
    [self.referView addSubview:blurView];
    [UIView animateWithDuration:0.5 animations:^{
          blurView.blurRadius = 17;
    }];
